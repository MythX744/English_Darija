...
def main():
    ...
    embedding_dim = 128
    model_configs = {
        'LSTM': {'hidden_size': 128, 'cell_type': LSTM},
        'Peehole': {'hidden_size': 128, 'cell_type': Peehole},
        'WMC': {'hidden_size': 128, 'cell_type': WMC},
        'Stacked_LSTM': {'hidden_size': 128, 'cell_type': StackedLSTM, 'num_layers': 2}
    }
